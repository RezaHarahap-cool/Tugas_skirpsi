...
import { 
  ClipboardList, Book, CalendarDays, Settings, User, LogOut, 
  MoreVertical,  X 
} from "lucide-react";
// ==========================================
// 1. KOMPONEN SIDEBAR
...
const menuItems = [
  { title: "Profile", icon: User, path: "/siswa" },
  { title: "Absensi", icon: ClipboardList, path: "/siswa/absensi" },
  { title: "Rapor", icon: Book, path: "/siswa/rapor" },
  { title: "Roster", icon: CalendarDays, path: "/siswa/roster" },
];
        ...
        <div className="p-4 border-t border-gray-200 relative">
          ...
          >
            ...
            <div className="flex-1 overflow-hidden">
              <p className="text-sm font-bold text-black truncate">Siswa</p>
              <p className="text-xs text-gray-500 truncate">Siswa@contoh.com</p>
            </div>
