...
export default function ModalHapusKelas({ kelas, onClose }: ModalHapusKelasProps) {
  // Jika tidak ada data kelas yang dipilih, modal tidak akan muncul
  if (!kelas) return null;

  const handleConfirmDelete = () => {
    console.log(`Data kelas "${kelas.namaKelas}" berhasil dihapus.`);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-md shadow-2xl p-6 md:p-8 animate-fade-in z-10 text-center">
        ...
        {/* Teks Peringatan */}
        <h3 className="text-xl font-extrabold text-black mb-2">Hapus Data Kelas?</h3>
        <p className="text-gray-500 text-sm mb-6 leading-relaxed">
          Apakah Anda yakin ingin menghapus kelas <span className="font-bold text-gray-800">"{kelas.namaKelas}"</span>? 
          <br />
